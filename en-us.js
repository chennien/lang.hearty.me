...
_h$["h"] = _h$["h"] || {
	...
	rate: ["Your review keeps our small team motivated to make Hearty Journal even better.", "Could you please rate us 5 stars?", "Thanks for your review.", "༼ つ ◕_◕ ༽つ"], 
...
_h$["m"] = _h$["m"] || {
	...
	menu: [
		"Verse of the Day", "Alice's Guestbook", "Post Feed", "My Journal", "Images", "Life Shop", "Upgrade", "Tutorials", "About", "Sign out", "for Windows", "for macOS", "Windows/macOS App", "Mobile App", "Language 語言", "Rate us 5 stars", "🐞 Debug"
	]
};
...
_h$["i"] = _h$["i"] || {
	...
	reset: [
		...
		"Open $url to check email？", 
		"The Hearty ID doesn't exist."
	], 
	ref: [
		"🎁 You're invited by $user."
	], 
	cookie: [
	...
	signup: [
		...
		"⚠ Yahoo! email service isn't recommended for use.\nDo you still want to use it?", 
	...
	song: ["Harmony - 溫度日記", "Soundtrack of Hearty Journal"], 
	...
	auth: [
		...
		"Forget ID/Password", 
		"Sign in now", 
		"Hearty ID", "💡 Hearty ID or account email", 
		"Password", "🔑 6 ~ 20 chars", 
		"Password again", "🔑 Enter password again", "Reveal the passwords", 
...
_h$["e"] = _h$["e"] || {
	...
	video: [
		...
		"Remove", 
		"Set (or leave blank to clear)", // 預留未使用
	...
	gps: [
		...
		'⛅ Please ALLOW the positioning request and wait a few seconds.', 
		"Weather data added", 
		"No GPS signals", 
	...
	rmenu: [
		"Help Center", "About", "Fullscreen", "繁/简", "Increase Font Size", "Decrease Font Size", "Flip book", "Vertical Reader Mode"
	], 
	image: [
	...
	tab: [
		"Mine", "Penpal's", 
		"🔍 Search", "🔖 Favorite", "🎧 Music Playlist", "🌙 Period Tracker", "🔒 Passcode Lock", 
...
_h$["p"] = _h$["p"] || {
	...
	feat_vip: [
		"including all features in lite, plus: ", 
		"Unlimited Number of Words", 
		"Post Images (Up to 10 images per post)", 
		"Image Gallery, 15+ Photo Effects", 
		"More Stickers (1,300+, Continuously updating)", 
...
_h$["f"] = _h$["f"] || {
	...
	gotop: "Go Top", 
	back: "Back", 
	covid19: ["For COVID-19 disease info, please refer to CDC's website. ( • ̀ω•́ )", "//go.hearty.me/cdc"]
};
...
_h$["o"] = _h$["o"] || {
	...
	fail_info: [ 
		...
		"Payment Declined", "Unusual or foreign transactions may trigger the card issuer’s automatic fraud prevention system to decline payments. In this case, informing card issuer to unblock the transaction can be helpful."
	], 
	fail_btn: [
		"Retry", 
		"Contact Support", 
...
_h$["em"] = _h$["em"] || {
	title: [
		"Unsubscribe from Member Newsletter", 
		"Unsubscribe from Shop Newsletter"
	], 
	unsubscribe: "Unsubscribe 取消訂閱", 
	ask: [
		"Once unsubscribed, you'll no longer receive member messages and penpal notifications.", 
		"Once unsubscribed, you'll no longer receive notifications of product releases and discounts.", 
		"Unsubscribe (Opt-out)"
	], 
	ok: "OK", 
	back: "Back", 
	unsubscribed: "\"$email\" has been successfully unsubscribed from newsletter. The change may take effect after one day. We apologize for any inconvenience.", 
	remarks: [
		"Please note that you may continue to receive transactional emails, such as account alerts, password reset links and announcements.", 
		"To opt out of all emails, please delete your Hearty ID."
	]
};
