...
_h$["p"] = _h$["p"] || {
	...
	iap_ios: [
		...
		"[Hearty Journal] iOS Subscription Terms",
		"Lite edition offers limited features and resources; upgrade to VIP for full access",
		"Subscription renews monthly at the price of your initial purchase",
		"After activation, it auto-renews and charges via your Apple account",
		"Once a subscription period starts, it cannot be canceled or refunded midway",
		"Auto-renews 24 hours before expiration; remember to cancel early if you don't want it",
		"Manage or change your plan anytime in Apple Account > Subscriptions",
		"We never ask for ATM transfers or bank operations over phone; if suspicious, call 165 anti-fraud hotline",
		"After purchase, trial period ends immediately. If you want more trial time, wait until trial ends to subscribe",
		"Terms of Services",
		"Privacy Policy"
	], 
	iap_and: [
		"Monthly auto-renewal, cancel anytime",
		"[Hearty Journal] Android Subscription Terms",
		"Lite edition offers limited features and resources; upgrade to VIP for full access",
		"Subscription renews monthly at the price of your initial purchase",
		"After activation, it auto-renews and charges via Google Play",
		"Once a subscription period starts, it cannot be canceled or refunded midway",
		"Auto-renews 24 hours before expiration; remember to cancel early if you don't want it",
		"Manage or change your plan anytime in Google Play > Payments & Subscriptions",
		"We never ask for ATM transfers or bank operations over phone; if suspicious, call 165 anti-fraud hotline",
		"",
		"Terms of Services",
		"Privacy Policy"
...
_h$["f"] = _h$["f"] || {
	...
	gotop: "Go Top", 
	back: "Back", 
	health: ["For health info, please refer to CDC's website. ( • ̀ω•́ )", "//www.cdc.gov.tw"]
};
